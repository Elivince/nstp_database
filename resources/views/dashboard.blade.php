                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2">
                         ...
                         <div class="p-6 bg-transparent sm:rounded-lg">
                             ...
                             <div class="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                                 ...
                                 <div class="container">
                                     <div class="ml-4 text-md tracking-wide font-semibold w-80">BU Student Union Center</div>
                                     <div class="ml-4 text-sm tracking-wide font-semibold w-30">Legazpi City, Albay</div>
                                 </div>
                             </div>
                             ...
                             <div class="flex items-center mt-4 text-gray-600 dark:text-gray-400">
                                 ...
                                 <div class="ml-4 text-md tracking-wide font-semibold w-40">+6390000000</div>
                             </div>
