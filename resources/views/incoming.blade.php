    ...
    <div x-cloak x-data="{open:false}" class="flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-gray-400">
        ...
        <form id="addRecordForm" action="/addIncoming" method="POST">
            ...
            <div class=" dark:bg-gray-800 px-2 rounded-xl mt-16 pb-7 py-5 mx-10">
                ...
                <h2 class="text-gray-300 pl-2 text-2xl text-center mb-2 pb-5 tracking-wider">Incoming Communication Tracker</h2>
                <div class="mx-20 mt-6 text-gray-500  dark:text-gray-200 leading-tight">
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            <label for="from_office" class="block text-sm font-normal text-gray-400">From what office</label>
                            <input type="text" name="from_office" id="from_office" class="h-8 text-sm mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full text-gray-400  dark:bg-gray-800 shadow-sm sm:text-xs border-gray-300 rounded-md">
                            @error('from_office')
                        ...
                        <div>
                            ...
                            <input type="text" name="remarks" id="remarks" class="h-8 text-sm mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full  dark:bg-gray-800 text-gray-400 shadow-sm sm:text-xs border-gray-300 rounded-md">
                            @error('remarks')
                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="text" name="action" id="action" class="h-8 text-sm mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-xs  dark:bg-gray-800 text-gray-400 border-gray-300 rounded-md">
                            @error('action')
                            <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <div class="w-full overflow-x-auto">
                    <div class="flex flex-col items-start px-2 pt-5">
                        <h2 class="text-gray-300 text-center text-2xl mb-2 pb-5 tracking-wider">List of Incoming Communication</h2>
                    </div>
                    <!-- component -->
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="text-xs  text-left font-semibold tracking-wide text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                <th class="px-4 py-3">
                                ...
                                <th class="pl-4 pr-0 py-3">Actions</th>
